        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <motion.div 
                className="inline-flex items-center space-x-3 text-2xl font-medium px-4 py-2 rounded-full ring-1 backdrop-blur-sm ${isDarkMode ? 'ring-blue-500/20 bg-white/5' : 'ring-blue-200 bg-white/70'}"
              ...
              <motion.p 
                ...
                className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} max-w-2xl mx-auto`}
              >
                Crafting digital experiences with passion and precision. Clean design, reliable code, and thoughtful details—built to last.
              </motion.p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              <p className={`text-sm ${isDarkMode ? 'text-gray-500' : 'text-gray-600'}`}>
                © {new Date().getFullYear()} Ian Wende. All rights reserved.
              </p>
            </motion.div>
