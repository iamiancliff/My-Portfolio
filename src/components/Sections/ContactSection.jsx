...
const ContactSection = () => {
  ...
  const formEndpoint = import.meta.env.VITE_CONTACT_ENDPOINT; 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prefer posting to a form endpoint if provided (e.g., Formspree/Getform/Web3Forms)
      if (formEndpoint) {
        ...
        // Fallback: open the user's email client so the message can still reach you
        const subject = encodeURIComponent(`New message from ${formData.name}`);
        const body = encodeURIComponent(`${formData.message}\n\nFrom: ${formData.name} <${formData.email}>`);
        window.location.href = `mailto:iancliff15@gmail.com?subject=${subject}&body=${body}`;
      }
    ...
    setTimeout(() => setShowSuccess(false), 3000);
      ...
      console.error(err);
      alert("Sorry—couldn't send your message right now. Please try again or email me directly at iancliff15@gmail.com.");
    } finally {
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              <h3 id="contact-form" className="text-2xl font-medium mb-8">Send me a message</h3>
