...
import { Zap, Cloud, Shield, Heart } from "lucide-react";
...
const SkillsSection = () => {
  ...
  const HIGHLIGHTS = [
    {
      title: "Performance‑minded (junior)",
      description: "Solid basics—clean bundles, smart loading; improving every release",
      icon: Zap,
      color: "text-yellow-400",
      bg: "bg-yellow-500/10",
    },
    {
      title: "Cloud‑in‑progress (AWS)",
      description: "AWS CCP certified; S3 hosting live, EC2 & CI/CD practice deployments",
      icon: Cloud,
      color: "text-cyan-400",
      bg: "bg-cyan-500/10",
    },
    {
      title: "Secure habits first",
      description: "Auth, input validation, env secrets; steadily deepening security skills",
      icon: Shield,
    ...
    },
    {
      ...
      description: "Clean, responsive React + Tailwind; ship small, test, iterate",
      icon: Heart,
      color: "text-pink-400",
      bg: "bg-pink-500/10",
    },
              ...
              <div className="flex items-start gap-4">
                <div
                  className={`p-3 rounded-xl ${item.bg} ${
                    isDarkMode ? "ring-1 ring-white/5" : ""
                  }`}
                >
