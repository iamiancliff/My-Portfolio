    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          >
            Full Stack Developer • Cloud Enthusiast • AWS Certified Cloud Practitioner
          </motion.div>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            >
              ...
              >
                As a junior full-stack developer, I am committed to continuous
                learning and growth. I thrive on exploring new technologies and
                tools as the tech landscape evolves, challenging myself to
                expand my knowledge and improve my skills. My focus is on
                building scalable, efficient solutions while staying adaptable
                and curious.
              </p>
              <p
                className={`text-lg leading-relaxed mb-6 ${
              ...
              >
                I embrace a growth mindset and value collaboration, actively
                seeking feedback and working with others to achieve innovative
                results. Cloud platforms like AWS inspire me to transform ideas
                into reliable products, and I enjoy documenting my journey and
                sharing knowledge to help both myself and others progress
                faster.
              </p>
            </motion.div>
